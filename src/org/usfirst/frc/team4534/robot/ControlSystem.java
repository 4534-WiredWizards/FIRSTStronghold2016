...
public class ControlSystem {
	...
	public static enum Button {
		MOVE_FORWARD, MOVE_BACKWARD, TURN_RIGHT, TURN_LEFT, PRECISION, TURBO, SHOOT, AIM_SHOOT, INTAKE, LEFT_ARM_TOGGLE, RIGHT_ARM_TOGGLE, ARMS_DOWN, ARMS_UP, LEFT_CLICK, RIGHT_CLICK, START, SELECT, LOW_GOAL, BRAKE_TOGGLE
	}
